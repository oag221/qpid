 ...
 */
#ifndef GALOIS_LAZYOBJECT_SMQ_H
#define GALOIS_LAZYOBJECT_SMQ_H
...
struct SafeData: public SafeDataBase<T, CharData,
  boost::has_trivial_constructor<T>::value || Galois_SMQ::has_known_trivial_constructor<T>::value > { };
