...
std::optional<std::pair<slkey_t,val_t>> lotan_shavit_delete_min_key(sl_intset_t *set, int order=0);
std::optional<std::pair<slkey_t,val_t>> spray_delete_min(sl_intset_t *set, thread_data_t *d);
std::optional<std::pair<slkey_t,val_t>> spray_delete_min_key(sl_intset_t *set, thread_data_t *d, int order=0);
