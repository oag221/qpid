...
int fraser_find(sl_intset_t *set, slkey_t key, val_t *val, int order=0);
int fraser_insert(sl_intset_t *set, slkey_t key, val_t v, int order=0);
int fraser_remove(sl_intset_t *set, slkey_t key, val_t *val, int remove_succ, int order=0);
void fraser_search(sl_intset_t *set, slkey_t key, sl_node_t **left_list, sl_node_t **right_list, int order=0);
